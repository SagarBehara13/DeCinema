...
class EndAndRepay extends Component {
  constructor(props) {
    super(props)
  ...
  async handleSubmit(event) {
    ...
    const errors = this.validate(this.state.filmId)
    ...
    this.state.film.methods.endFilmAndRepay(this.state.filmId)
      ...
      <div className="container-fluid">
        <div className="row">
          <Form onSubmit={this.handleSubmit} className="addform-container col-12 col-md-9">
            <h2>End a request and repay the contributors</h2>
            <FormGroup row>
...
export default withRouter(EndAndRepay)
